...
const Books = (props)=> {
    ...
    return <div>
        <div className="row">
            <div className="col-md-1"><img src={item.img} height="100" width="60"></img></div>
    ...
    return (
        <div className="books">
            ...
            <div className="heading">
                <img src={BookImg}></img> <span> ~ “A reader lives a thousand lives before he dies . . . The man who never reads lives only one.” – George R.R. Martin</span>
            </div>
            <hr/>
