...
const Healthcare = () =>{
    ...
    return <div className="healthcare">
        ...
        <div className="row">   
            ...
            <div className="">
            <div className="col-md-4 col-xs-12"><Stopwatch showCard={showResult}/></div>
                {showCard==='pass' && <div className="card pass col-md-7 col-xs-12">
                    <h4><img src={Success} height="150" width="150"></img><span>GREAT!! Your lungs are strong enough.</span></h4>
                </div>
                }       
                {showCard==='fail' && <div className="card fail col-md-7 col-xs-12">
