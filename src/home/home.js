...
const Home = () =>{
    return <div>
        ...
        <p>As we all know, we are in the wake of COVID-19. 
         ...
         <p>To beat your free time, visit <a href="/tips">Activities Admist COVID-19</a> section.</p> 
         Things you can gain insight to:
         <ul>
            <li> Trending Netflix, Prime series</li>
            <li> All-time favorite movies to watch with family</li>
            <li> Bestseller novels of 2020 </li>
        </ul>  
        <p>Apart from that, you can have some <a href="/healthcare">heath care tips</a> like symptoms, precautions, DOs and DON'Ts </p>
